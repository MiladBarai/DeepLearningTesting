...
def train_or_load_network(network, training_images, training_lables):
    ...
    folder = "Deep Neural Network Training/" + network.name + "/"
...
# Create model with a 3x3 Convolution filter. 0.25 dropout. same padding. Two hidden layers and Max Pooling
